...
function MeetModal({ link, onClose }) {
  return (
    <div className="fixed inset-0 bg-black/80 z-[200] flex flex-col">
      ...
      <iframe src={link} allow="camera; microphone; fullscreen; display-capture; autoplay" sandbox="allow-same-origin allow-scripts allow-popups allow-forms allow-pointer-lock allow-modals allow-presentation" className="flex-1 w-full border-0" title="Google Meet" />
    </div>
  );
}
