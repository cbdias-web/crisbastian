...
const sections = [
  ...
  },
  {
    ...
    content: [
      ...
      { subtitle: '🔔 Notificações automáticas de compromissos', text: 'O sistema verifica automaticamente os compromissos agendados com horário definido e envia uma notificação na tela (e pelo navegador, se permitido) exatamente 15 minutos antes. Nenhuma configuração adicional é necessária — funciona assim que a conta Google estiver conectada.' },
