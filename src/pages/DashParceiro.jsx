    ...
    return (
      <div className="min-h-screen flex items-center justify-center p-6" style={{ background: AURORA.bg }}>
        <div className="text-center max-w-sm">
          ...
          <p className="text-sm" style={{ color: AURORA.textMuted }}>O Dash Parceiro é exclusivo para administradores.</p>
        </div>
      </div>
    );
  }
        ...
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <p className="text-sm" style={{ color: AURORA.textMuted }}>
              Gestão de Indicadores e suas indicações — mesma base que o portal do indicador acessa
            </p>
          </div>
        </div>
